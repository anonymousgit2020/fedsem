...
from utils.stat_utils import get_f1
...
class ClientModel(Model):
    ...
    def create_model(self):
        ...
        c_f1 = get_f1(label_ph, predictions)
        return input_ph, label_ph, minimize_op, eval_metric_ops, tf.math.reduce_mean(loss), pred_ops, c_f1
